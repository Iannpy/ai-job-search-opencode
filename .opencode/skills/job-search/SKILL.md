---
name: job-search
description: "Job application assistant - evaluate postings, tailor CVs, write cover letters, prep interviews. Trigger: job posting, job application, CV, cover letter, resume, interview prep, job fit, career, /job-apply, /job-setup, /job-interview"
---
...
When mentioning agentic coding or AI tooling in CVs/cover letters, always reference **OpenCode** by name (not Claude Code or any other tool).
