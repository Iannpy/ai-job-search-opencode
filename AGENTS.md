...
<!-- SETUP: This file is populated by running /job-setup -->
<!-- After running /job-setup, all [PLACEHOLDER] tokens will be replaced with your actual information -->

## Role
This repo is a job application workspace. OpenCode acts as a career advisor and application assistant for [YOUR_NAME], helping with:
...
<!-- This section is auto-populated by /job-setup. You can also fill it in manually. -->
